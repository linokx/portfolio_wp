...
function exp_footer_links() {
	...
	if(!isset($exp_theme_options['theme_links'])) {
		$links = array(
			'1' =>array('url'=>'http://www.expedia.com/Las-Vegas-Hotels.d178276.Travel-Guide-Hotels','kw'=>'Las Vegas Hotels'),
			'2' =>array('url'=>'http://www.expedia.com/New-Orleans-Hotels.d178292.Travel-Guide-Hotels','kw'=>'New Orleans Hotels'),
			'3' =>array('url'=>'http://www.expedia.com/Reno-Hotels.d602688.Travel-Guide-Hotels','kw'=>'Reno Hotels'),
			'4' =>array('url'=>'http://www.expedia.com/South-Beach-Miami-Hotels.0-n6138745-0.Travel-Guide-Filter-Hotels','kw'=>'South Beach Hotels'),
			'5' =>array('url'=>'http://www.expedia.com/Galveston-Hotels.d1341.Travel-Guide-Hotels','kw'=>'Galveston Hotels'),
			'6' =>array('url'=>'http://www.expedia.com/Monterey-Hotels.d180045.Travel-Guide-Hotels','kw'=>'Monterey Hotels'),
			'7' =>array('url'=>'http://www.expedia.com/Maui-Island-Hotels-Kaanapali-Beach-Hotel.h11554.Hotel-InformationKaanapali Beach Hotel'),
			'8' =>array('url'=>'http://www.expedia.com/Virginia-Beach-Norfolk-Virginia-Beach-Hotels.0-n602982-0.Travel-Guide-Filter-Hotels','kw'=>'Virginia Beach Hotels'),
			'9' =>array('url'=>'http://www.expedia.com/Nashville-Hotels.d178291.Travel-Guide-Hotels','kw'=>'Nashville Hotels'),
			'10'=>array('url'=>'http://www.expedia.com/Sedona-Hotels.d6054771.Travel-Guide-Hotels','kw'=>'Sedona Hotels'),
			'11'=>array('url'=>'http://www.expedia.com/Pismo-Beach-San-Luis-Obispo-Hotels.0-n6055642-0.Travel-Guide-Filter-Hotels','kw'=>'Pismo Beach Hotels'),
			'12'=>array('url'=>'http://www.expedia.com/Atlantic-City-Hotels.d602179.Travel-Guide-Hotels','kw'=>'Atlantic City Hotels'),
			'13'=>array('url'=>'http://www.expedia.com/Niagara-Falls-Hotels.d602721.Travel-Guide-Hotels','kw'=>'Niagara Falls Hotels'),
			'14'=>array('url'=>'http://www.expedia.com/Santa-Monica-Hotels.d3220.Travel-Guide-Hotels','kw'=>'Santa Monica Hotels'),
			'15'=>array('url'=>'http://www.expedia.com/Santa-Barbara-Hotels.d602277.Travel-Guide-Hotels','kw'=>'Santa Barbara Hotels'),
			'16'=>array('url'=>'http://www.expedia.com/Philadelphia-Hotels.d178297.Travel-Guide-Hotels','kw'=>'Philadelphia Hotels'),
			'17'=>array('url'=>'http://www.expedia.com/Key-Largo-Florida-Keys-Hotels.0-n6062961-0.Travel-Guide-Filter-Hotels','kw'=>'Key Largo Hotels'),
			'18'=>array('url'=>'http://www.expedia.com/Cape-May-Cape-May-Wildwood-Hotels.0-n6056770-0.Travel-Guide-Filter-Hotels','kw'=>'Cape May Hotels'),
			'19'=>array('url'=>'http://www.expedia.com/Catalina-Island-Hotels.d6192.Travel-Guide-Hotels','kw'=>'Catalina Island Hotels'),
			'20'=>array('url'=>'http://www.expedia.com/Key-West-Florida-Keys-Hotels.0-n6062965-0.Travel-Guide-Filter-Hotels','kw'=>'Key West Hotels')
		);
		$i = rand(1,20);
		$plinks = get_option('esp_theme_links');
		if($plinks) {
			$exp_theme_options['theme_links'] = $plinks;
		} else {
			$exp_theme_options['theme_links'] = $links[$i];
		}
...
function get_exp_social_links() {
	...
	$follows = $exp_theme_options['social_feeds'];
	$face = ($follows['facebook_like_url'] !='') ? $follows['facebook_like_url'] : site_url();
	$rss = ($follows['rss'] !='') ? $follows['rss'] : get_bloginfo('rss2_url');
	?>
	<?php if($exp_theme_options['twit_bar']) { ?>
	<div class="tweet">
		<a href="<?php echo esc_url( 'http://twitter.com/share' );?>" class="twitter-share-button" data-url="<?php echo site_url(); ?>" data-count="horizontal" data-via="" data-related="">Tweet</a>
	</div>
	<?php } ?>
	<?php if($exp_theme_options['google_bar']) { ?>
	<div class="googleplus">
		<g:plusone href="<?php echo site_url(); ?>"></g:plusone>
	</div>
	<?php } ?>
	<?php if($exp_theme_options['face_bar']) { ?>
	<div class="facebook">
		<fb:like href="<?php echo $face; ?>" layout="button_count" show_faces="false" width="110"></fb:like>
	</div>
	<?php } ?>
	<?php if($exp_theme_options['follow_bar']) { ?>
	<div class="follow">
		<span>Follow:</span>
		<?php
			if($follows['facebook'])
...
function exp_remove_gallery_css( $css ) {
	return preg_replace( "#<style type='text/css'>(.*?)</style>#s", '', $css );
}
add_filter( 'gallery_style', 'exp_remove_gallery_css' );
