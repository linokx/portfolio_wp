 ...
 * JS Document - /jquery/box/js/jquery.box.js
...
( function( $ ) {
	$.fn.box = function( settings ) {
			...
			var $img = $('<img src="'+elements[currentIndex]+'"/>').css({
				...
				.hide().appendTo('body').load(function(){
					...
					$container.animate({
							...
							$img.remove().appendTo($container).fadeIn().on('click.box',nextImage);
						});
				});
		...
		return this.each(function(){
			...
			$(this).on("click.box",elementClicked);
		});

	};

} )( jQuery );
//Espace de nom = espace virtuelle où tout evenement, variable est prefixé qui dit que c'est a nous