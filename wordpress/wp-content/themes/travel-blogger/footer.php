				...
				<div id="site-disclaimer">
					<?php
							...
							if( (is_home() || is_front_page() || is_page() || is_category()) && $footerlinks['add_credit'] !='') {
								$themelink = (isset($exp_theme_options['theme_links'])) ? $exp_theme_options['theme_links'] : array('url'=>'http://www.expedia.com','kw'=>'Travel'); ?>
								<p class="theme-links add-links">Designed by the Expedia <a href="<?php echo $themelink['url']; ?>"><?php echo $themelink['kw']; ?></a> Team.</p>
							<?php } ?>
				</div><!-- #site-disclaimer -->
	</div><!-- #ft -->
